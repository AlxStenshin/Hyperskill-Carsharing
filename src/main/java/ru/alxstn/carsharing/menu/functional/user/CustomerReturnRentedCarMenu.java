...
public class CustomerReturnRentedCarMenu extends ReturnToPreviousState {
    private final DatabaseDao db;
    private final int userId;

    public CustomerReturnRentedCarMenu(DatabaseDao db, int userId, State returnToState) {
        super(returnToState);
        this.db = db;
        this.userId = userId;
    }
